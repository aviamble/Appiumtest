...
//		
	    ...
	    String directoryPath="C:\\WebPortal\\Input\\Batch1";
	    ...
	    for (Entry<String, String> FilesInfo : inputFilesEntrySet) 
	    {
	      try
	       ...
	       // WebElement errorMsg=getDriverInstance().findElement(By.xpath("/html/body/app-root/div[2]/div[1]/div[2]/span/h5"));
	        ...
	        boolean elemPresent=isElementPresent(By.xpath("//button[contains(text(),'Download')]"));
	        ...
	        WebElement downloadBtn=getDriverInstance().findElement(By.xpath("//button[contains(text(),'Download')]")); 
...
//	        alert.accept();
		 ...
		 catch(Exception e) { System.out.println("File is not processed"); } }
	   ...
	   {
	   	String downloadpath="C:\\WebPortal\\OutPut\\NewXmlOutput\\";
	    
	   	String destpath="C:\\WebPortal\\OutPut\\FinalOutput\\";
	   	
	   	String alreadyDonePath="C:\\WebPortal\\InPut\\AlreadyDoneAutomated\\"+FileName;
	  	...
	  	String xmlOutputName= foldername +".xml";
	  	
	  	File xmlSource= new File(downloadpath+xmlOutputName);
	  	
	  	File xmlDest= new File(destpath+foldername +"\\"+foldername +".xml");
